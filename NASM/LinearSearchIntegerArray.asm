...
section .data
    ...
    message3 db 'Enter The Element to be searched  :', 10,0
    message4 db 'The Entered number is found at the index :',10,0
    message5 db 'The Element Entered could not be found in the array.', 10,0
    NEW_LINE db 10   
