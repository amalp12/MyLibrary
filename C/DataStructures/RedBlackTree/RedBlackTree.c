...
void RedBlackTree_Transplant(BST_node_ptr*  root, BST_node_ptr a, BST_node_ptr b)
{
    // transplanting a with b
    if (a->parent==NULL)
    {
        (*root) = b;
    }
...
void RedBlackTree_Delete_Fix(BST_node_ptr * root,BST_node_ptr node)
{

    BST_node_ptr sibling;
    ...
    while(node!=(*root) && node -> color == 0)
    {
        ...
        if(node ==node->left)
        {
            ...
            if(sibling->color == 1)
            {
                ...
                // set the color of right child of parent to black
            ...
            if( sibling->left->color ==0 && sibling->right->color ==0)
            {
                ...
                // set the color of sibling to red and set the color of parent to black
                sibling->color = 1;
                node = node->parent;
            }
            else 
            {
                ...
                {
                    // case 3 : if right child of sibling is black
                    // set the color of right child of sibling to red and set the color of parent to black
                ...
                // case 4 : if right child of sibling is red
                // set the color of sibling to the color of parent
        ...
        else
        {
            ...
            {
                // case 1 : if sibling is red
                // set the color of left child of parent to black
            ...
            else 
            {
                ...
                {
                    // case 3 : if left child of sibling is black
                    // set the color of left child of sibling to red and set the color of parent to black
                    sibling->right->color = 0;
                    sibling->color = 1;
                    leftRotate(sibling);
                    sibling = node->parent->left;
                ...
                // case 4 : if left child of sibling is red
                // set the color of sibling to the color of parent
                sibling->color = node->parent->color;
                node->parent->color = 0;
                sibling->left->color = 0;
...
BST_node_ptr DeleteRedBlack( BST_node_ptr root , int key)
{
   ...
   // if the node is not found
    ...
    BST_node_ptr node_to_delete = current;

    // if left child of the node is null
    if(node_to_delete->left==NULL)
    {
        current = node_to_delete->right;
        // transplant the node to delete with current 
        RedBlackTree_Transplant(&root, node_to_delete, current);
    ...
    else
    {
        ...
        BST_node_ptr temp = minValueNode(node_to_delete->right);
        original_color = temp->color;
        current = temp->right;
        if(temp == node_to_delete->left || temp == node_to_delete->right)
        {
            current->parent = temp;
        }
        else
        {
            RedBlackTree_Transplant(&root, temp, temp->right);
            temp->right = node_to_delete->right;
            temp->right->parent = temp;
        }
        RedBlackTree_Transplant(&root, node_to_delete, temp);
        ...
        if(original_color==0)
        {
            RedBlackTree_Delete_Fix(&root, current);
        }
    }
    return root;
