...
int main()
{
    ...
    vector<int> :: iterator  it2 = upper_bound(A.begin(), A.end(), 100) ; // > (returns pointer of element strictly greater than)
    ...
    */
    ...
    for(it3 = A.begin(); it3 !=A.end(); it3++) // note A.end() returns an iterator one past the last element 
    {
        cout << *it3 << "\t" ;
    }
    cout << endl;
